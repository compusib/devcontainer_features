...
print_help()
{
	...
	printf '\t%s\n' "-d, --hooks-dir: Custom source directory for hooks (default: '$GIT_HOOKS_DIR')"
	...
	printf '\t%s\n' "FEATURE_LIB_DIR: "/usr/local/lib/features". (default: 'Path to feature library directory')"
	printf '\t%s\n' "GIT_HOOKS_DIR: "git/hooks". (default: 'Path to git hooks source directory')"
...
test -n "$FEATURE_LIB_DIR" || FEATURE_LIB_DIR="Path to feature library directory"

test -n "$GIT_HOOKS_DIR" || GIT_HOOKS_DIR="Path to git hooks source directory"
